...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const handleGoogleLogin = async () => {
    ...
    // On success, the page redirects to Google — onAuthStateChange in App.tsx handles the callback
  };
      ...
      <div className="relative z-10 w-full max-w-md bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">
            ...
            <span className="text-white font-medium">
              {targetMode === "CUSTOMER" ? "Digital Menu" : "Owner Dashboard"}
            </span>
          </p>
        </div>
        ...
        <div className="relative py-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-zinc-900 px-3 text-[10px] font-medium text-zinc-600 uppercase tracking-widest">
              Or continue with
            </span>
          </div>
        </div>
