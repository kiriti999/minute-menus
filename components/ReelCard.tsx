...
export const ReelCard: React.FC<ReelCardProps> = ({ dish, onAddToOrder, currency = "USD" }) => {
  ...
  return (
    <div className="relative w-full h-full bg-black overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 pb-20 sm:p-6 sm:pb-12 z-20 flex flex-col justify-end pointer-events-none">
        <div className="max-w-[80%] mb-6">
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-none tracking-tight mb-3 drop-shadow-lg">
            {dish.name}
          </h3>
